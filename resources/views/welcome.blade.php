            ...
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        ...
                        <a href="{{route('horoscopes.index')}}" class="ml-4 text-sm text-gray-700">Horoscopes</a>
                        
                        <a href="{{route('zodiac-signs.index')}}" class="ml-4 text-sm text-gray-700" >Zodiac Signs</a>
                        @endif 
                    @else
